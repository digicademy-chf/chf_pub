...
$GLOBALS['TCA']['tx_chfbase_domain_model_resource']['types'] += ['publicationResource' => [
   ...
   --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.content,allEssays,allVolumes,allAgents,allLocations,allPeriods,allTags,allRelations,allFileGroups,
