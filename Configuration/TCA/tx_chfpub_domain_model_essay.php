...
return [
    ...
    'palettes' => [
        'parentVolumeParentEssay' => [
            'showitem' => 'parentVolume,parentEssay,',
        ],
    ...
    'types' => [
        '0' => [
            'showitem' => 'parentResource,--palette--;;parentVolumeParentEssay,uuid,title,extent,isHighlight,label,sameAs,
